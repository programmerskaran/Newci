					...
					<ul class="main-menu">
						...
						<li class="slide has-sub">
							...
							<ul class="slide-menu child1">
								...
								<li class="slide"><a href="form-elements.html" class="side-menu__item">FormElements</a>
								</li>
								...
								<li class="slide"><a href="file-upload.html" class="side-menu__item">File Uploads</a>
								</li>
								<li class="slide"><a href="form-checkbox.html" class="side-menu__item">Form-Checkbox</a>
								</li>
								...
								<li class="slide"><a href="form-layouts.html" class="side-menu__item">Form-Layouts</a>
								</li>
						...
						<li class="slide has-sub">
							...
							<ul class="slide-menu child1">
								...
								<li class="slide"><a href="draggable.html" class="side-menu__item">Draggable Cards</a>
								</li>
								<li class="slide"><a href="notifications.html" class="side-menu__item">Notifications</a>
								</li>
								...
								<li class="slide has-sub"><a href="javascript:void(0);" class="side-menu__item">File
									...
									<ul class="slide-menu child2">
										<li class="slide"><a href="filemanager.html" class="side-menu__item">File
												manager</a></li>
										<li class="slide"><a href="filemanager-list.html" class="side-menu__item">File
												manager List</a></li>
						...
						<li class="slide has-sub">
							...
							<ul class="slide-menu child1">
								...
								<li class="slide has-sub"><a href="javascript:void(0);" class="side-menu__item">Tables<i
									...
									<ul class="slide-menu child2">
										<li class="slide"><a href="tables.html" class="side-menu__item">BasicTables</a>
										</li>
							...
							<ul class="slide-menu child1">
								...
								<li class="slide has-sub"><a href="javascript:void(0);" class="side-menu__item">Blog<i
									...
									<ul class="slide-menu child2">
										...
										<li class="slide"><a href="blog-edit.html" class="side-menu__item">Edit Blog</a>
										</li>
									</ul>
								</li>
								...
								<li class="slide has-sub"><a href="javascript:void(0);"
									...
									<ul class="slide-menu child2">
										...
										<li class="slide"><a href="product-list.html" class="side-menu__item">Product
												list</a>
										</li>
										...
										<li class="slide"><a href="wishlist.html" class="side-menu__item">Whislist</a>
										</li>
									</ul>
								</li>
								...
								<li class="slide"><a href="terms.html" class="side-menu__item">Terms&amp;conditions</a>
								</li>
						...
						<li class="slide has-sub">
							...
							<ul class="slide-menu child1">
								...
								<li class="slide"><a href="tabler-icons.html" class="side-menu__item">Tabler Icons</a>
								</li>
							...
							<ul class="slide-menu child1">
								...
								<li class="slide has-sub"><a href="javascript:void(0);" class="side-menu__item">Reset
									...
									<ul class="slide-menu child2">
										...
										<li class="slide"><a href="reset-cover.html" class="side-menu__item">Cover-1</a>
										</li>
								...
								<li class="slide has-sub"><a href="javascript:void(0);"
										class="side-menu__item">Lockscreen<i
											class="ri ri-arrow-right-s-line side-menu__angle"></i></a>
									<ul class="slide-menu child2">
										<li class="slide"><a href="lockscreen.html" class="side-menu__item">Basic</a>
										</li>
								...
								<li class="slide has-sub"><a href="javascript:void(0);" class="side-menu__item">Two-Step
									...
									<ul class="slide-menu child2">
										<li class="slide"><a href="verfication.html" class="side-menu__item">Basic</a>
										</li>
								...
								<li class="slide"><a href="maintanace.html" class="side-menu__item">Under Maintanace</a>
								</li>
							...
							<div class="header-nav-right">
								<div class="header-country hs-dropdown ti-dropdown hidden sm:block"
									...
									<button id="dropdown-flag" type="button"
										...
										<img src="<?php echo base_url(); ?>dist/assets/img/flags/10.png" alt="flag-img"
										...
										<div class="ti-dropdown-divider divide-y divide-gray-200 dark:divide-white/10">
											<div class="py-2 first:pt-0 last:pb-0">
												<div class="ti-dropdown-item">
													<div class="flex items-center space-x-2 rtl:space-x-reverse w-full">
														<div class="h-[1.375rem] w-[1.375rem] rounded-sm">
															<img src="<?php echo base_url(); ?>dist/assets/img/flags/10.png"
																alt="flag-img">
														</div>
														<div>
												...
												<div class="ti-dropdown-item">
													<div class="flex items-center space-x-2 rtl:space-x-reverse w-full">
														<div class="h-[1.375rem] w-[1.375rem] rounded-sm">
															<img src="<?php echo base_url(); ?>dist/assets/img/flags/1.png"
																alt="flag-img">
														</div>
														<div>
															<p class="text-xs font-medium">
												...
												<div class="ti-dropdown-item">
													<div class="flex items-center space-x-2 rtl:space-x-reverse w-full">
														<div class="h-[1.375rem] w-[1.375rem] rounded-sm">
															<img src="<?php echo base_url(); ?>dist/assets/img/flags/2.png"
																alt="flag-img">
														</div>
														<div>
															<p class="text-xs font-medium">
												...
												<div class="ti-dropdown-item">
													<div class="flex items-center space-x-2 rtl:space-x-reverse w-full">
														<div class="h-[1.375rem] w-[1.375rem] rounded-sm">
															<img src="<?php echo base_url(); ?>dist/assets/img/flags/3.png"
																alt="flag-img">
														</div>
														<div>
															<p class="text-xs font-medium">
												...
												<div class="ti-dropdown-item">
													<div class="flex items-center space-x-2 rtl:space-x-reverse w-full">
														<div class="h-[1.375rem] w-[1.375rem] rounded-sm">
															<img src="<?php echo base_url(); ?>dist/assets/img/flags/4.png"
																alt="flag-img">
														</div>
														<div>
															<p class="text-xs font-medium">
												...
												<div class="ti-dropdown-item">
													<div class="flex items-center space-x-2 rtl:space-x-reverse w-full">
														<div class="h-[1.375rem] w-[1.375rem] rounded-sm">
															<img src="<?php echo base_url(); ?>dist/assets/img/flags/5.png"
																alt="flag-img">
														</div>
														<div>
															<p class="text-xs font-medium">
											...
											<div class="py-2 first:pt-0 last:pb-0" id="allCartsContainer">
												<div class="ti-dropdown-item relative header-box">
													<a href="cart.html"
														...
														<img loading="lazy"
															src="<?php echo base_url(); ?>dist/assets/img/ecommerce/products/1.png"
															alt="product-img"
												...
												<div class="ti-dropdown-item relative header-box">
													<a href="cart.html"
														class="flex items-center space-x-3 rtl:space-x-reverse w-full">
														<img loading="lazy"
															src="<?php echo base_url(); ?>dist/assets/img/ecommerce/products/2.png"
															alt="product-img"
															class="avatar p-2 shadow-none  shrink-0 items-center justify-center rounded-sm bg-gray-100 dark:bg-black/20 !ring-transparent">
														<div>
															<p
												...
												<div class="ti-dropdown-item relative header-box">
													<a href="cart.html"
														class="flex items-center space-x-3 rtl:space-x-reverse w-full">
														<img loading="lazy"
															src="<?php echo base_url(); ?>dist/assets/img/ecommerce/products/9.png"
															alt="product-img"
															class="avatar p-2 shadow-none  shrink-0 items-center justify-center rounded-sm bg-gray-100 dark:bg-black/20 !ring-transparent">
														<div>
															<p
												...
												<div class="ti-dropdown-item relative header-box">
													<a href="cart.html"
														class="flex items-center space-x-3 rtl:space-x-reverse w-full">
														<img loading="lazy"
															src="<?php echo base_url(); ?>dist/assets/img/ecommerce/products/10.png"
															alt="product-img"
															class="avatar p-2 shadow-none  shrink-0 items-center justify-center rounded-sm bg-gray-100 dark:bg-black/20 !ring-transparent">
														<div>
															<p
													...
													<a href="mail-inbox.html"
														...
														<div class="relative w-full">
															...
															<p class="text-xs mb-1 max-w-[200px] truncate">Hello there!
																How are you doing? Call me when...</p>
													...
													<a href="mail-inbox.html"
														...
														<div class="relative w-full">
															...
															<p class="text-xs mb-1 max-w-[200px] truncate">I would like
																to discuss about that assets...</p>
