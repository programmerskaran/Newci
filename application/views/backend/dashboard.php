                                    ...
                                    <div class="box-body">
                                        <div class="flex justify-between">
                                            <div class="flex-1">
                                                ...
                                                <h5 class="mb-1 text-3xl text-gray-800 dark:text-white font-medium">
                                                    $75,234
                                                    <span
                                                        class="text-xs text-gray-500 dark:text-white/70 font-normal ">/
                                                        month</span>
                                                </h5>
                                                <span class="text-gray-500 dark:text-white/70"><i
                                                        class="ti ti-trending-up text-success"></i>
                                                    +5%
                                    ...
                                    <div class="box-body">
                                        <div class="flex justify-between">
                                            <div class="flex-1">
                                                ...
                                                <span class="text-gray-500 dark:text-white/70"><i
                                                        class="ti ti-trending-down text-danger"></i>
                                                    -10%
                                                    than last month</span>
                                            </div>
                                            <div class="ltr:ml-auto rtl:mr-auto">
                                        ...
                                        <ul class="flex flex-col">
                                            <li
                                                ...
                                                <div class="">
                                                    <a href="profile.html"
                                                        ...
                                                        <img class="avatar avatar-sm rounded-sm"
                                                            src="<?php echo base_url(); ?>dist/assets/img/users/2.jpg"
                                                ...
                                                <div class="ltr:ml-auto rtl:mr-auto space-x-2 rtl:space-x-reverse">
                                                    <a aria-label="anchor" href="contacts.html"
                                            ...
                                            <li
                                                ...
                                                <div class="">
                                                    <a href="profile.html"
                                                        class="flex items-center space-x-3 rtl:space-x-reverse">
                                                        <img class="avatar avatar-sm rounded-sm"
                                                            src="<?php echo base_url(); ?>dist/assets/img/users/3.jpg"
                                                            alt="Image Description">
                                                        <div class="flex">
                                                            <div class="block my-auto">
                                                                <p
                                                ...
                                                <div class="ltr:ml-auto rtl:mr-auto space-x-2 rtl:space-x-reverse ">
                                                    <a aria-label="anchor" href="contacts.html" class="text-danger">
                                            ...
                                            <li
                                                ...
                                                <div class="">
                                                    <a href="profile.html"
                                                        class="flex items-center space-x-3 rtl:space-x-reverse">
                                                        <img class="avatar avatar-sm rounded-sm"
                                                            src="<?php echo base_url(); ?>dist/assets/img/users/10.jpg"
                                                            alt="Image Description">
                                                        <div class="flex">
                                                            <div class="block my-auto">
                                                                <p
                                            ...
                                            <li
                                                ...
                                                <div class="">
                                                    <a href="profile.html"
                                                        class="flex items-center space-x-3 rtl:space-x-reverse">
                                                        <img class="avatar avatar-sm rounded-sm"
                                                            src="<?php echo base_url(); ?>dist/assets/img/users/12.jpg"
                                                            alt="Image Description">
                                                        <div class="flex">
                                                            <div class="block my-auto">
                                                                <p
                                            ...
                                            <li
                                                ...
                                                <div class="">
                                                    <a href="profile.html"
                                                        class="flex items-center space-x-3 rtl:space-x-reverse">
                                                        <img class="avatar avatar-sm rounded-sm"
                                                            src="<?php echo base_url(); ?>dist/assets/img/users/5.jpg"
                                                            alt="Image Description">
                                                        <div class="flex">
                                                            <div class="block my-auto">
                                                                <p
                                            ...
                                            <li
                                                ...
                                                <div class="">
                                                    <a href="profile.html"
                                                        class="flex items-center space-x-3 rtl:space-x-reverse">
                                                        <img class="avatar avatar-sm rounded-sm"
                                                            src="<?php echo base_url(); ?>dist/assets/img/users/15.jpg"
                                                            alt="Image Description">
                                                        <div class="flex">
                                                            <div class="block my-auto">
                                                                <p
                    ...
                    <div class="col-span-12 xxl:col-span-3">
                        <div class="box text-white overflow-hidden">
                            <div
                                ...
                                <img src="<?php echo base_url(); ?>dist/assets/img/png-images/16.png" alt=""
                                            ...
                                            <div class="flex-1">
                                                ...
                                                <div class="flex items-center justify-between">
                                                    <div class="flex -space-x-2 rtl:space-x-reverse">
                                                        <img class="inline-block avatar w-6 h-6 rounded-full"
                                                            src="<?php echo base_url(); ?>dist/assets/img/users/8.jpg"
                                                            alt="Image Description">
                                                        <img class="inline-block avatar w-6 h-6 rounded-full"
                                                            src="<?php echo base_url(); ?>dist/assets/img/users/4.jpg"
                                                            alt="Image Description">
                                                        <img class="inline-block avatar w-6 h-6 rounded-full"
                                                            src="<?php echo base_url(); ?>dist/assets/img/users/6.jpg"
                                                            alt="Image Description">
                                                        <img class="inline-block avatar w-6 h-6 rounded-full"
                                                            src="<?php echo base_url(); ?>dist/assets/img/users/7.jpg"
                                                            alt="Image Description">
                                                    </div>
                                                ...
                                                <div class="flex items-center justify-between">
                                                    <div class="flex -space-x-2 rtl:space-x-reverse">
                                                        ...
                                                        <span
                                                            ...
                                                            <span
                                                                class="font-medium text-gray-500 leading-none dark:text-white/70">9+</span>
                                                        </span>
                                                    </div>
                                                    <span class="text-gray-500 dark:text-white/70 flex text-xs"><i
                                                            class="ri-time-line ltr:mr-1 rtl:ml-1 my-auto "></i>10-04-23</span>
                                                ...
                                                <div class="flex items-center justify-between">
                                                    <div class="flex -space-x-2 rtl:space-x-reverse">
                                                        ...
                                                        <img class="inline-block avatar w-6 h-6 rounded-full"
                                                            ...
                                                            alt="Image Description">
                                                        <img class="inline-block avatar w-6 h-6 rounded-full"
                                                            src="<?php echo base_url(); ?>dist/assets/img/users/21.jpg"
                                                            alt="Image Description">
                                                    </div>
                                                    <span class="text-gray-500 dark:text-white/70 flex text-xs"><i
                                                            class="ri-time-line ltr:mr-1 rtl:ml-1 my-auto "></i>10-04-23</span>
                                ...
                                <ul class="">
                                    <li class="p-0 mb-5 ti-list-group border-0 text-gray-800 dark:text-white w-full">
                                        <div class="flex items-start w-full">
                                            <a href="chat.html" class="ltr:mr-2 rtl:ml-2 avatar rounded-full">
                                                <img src="<?php echo base_url(); ?>dist/assets/img/users/17.jpg"
                                                    alt="img" class="rounded-full">
                                            </a>
                                            <div class="flex justify-between relative w-full">
                                                <a aria-label="anchor" href="chat.html"
                                                    class="absolute h-full w-full inset-0"></a>
                                                <div class="">
                                                    <h5 class="text-sm text-gray-800 dark:text-white font-semibold">Elon
                                                        Isk</h5>
                                                    <span class="text-xs text-gray-500 dark:text-white/70">Hello there!
                                                        How are you doing? Call me when...</span>
                                                </div>
                                                <div class="min-w-fit ltr:ml-2 rtl:mr-2 text-end">
                                                    <p class="text-xs text-gray-500 dark:text-white/70 mb-1">2 min</p>
                                                    <span
                                                        class="relative inline-flex rounded-full h-5 w-5 bg-primary text-white justify-center items-center">2</span>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="p-0 mb-5 ti-list-group border-0 text-gray-800 dark:text-white w-full">
                                        <div class="flex items-start w-full">
                                            <a href="chat.html" class="ltr:mr-2 rtl:ml-2 avatar rounded-full">
                                                <img src="<?php echo base_url(); ?>dist/assets/img/users/2.jpg"
                                                    alt="img" class="rounded-full">
                                            </a>
                                            <div class="flex justify-between relative w-full">
                                                <a aria-label="anchor" href="chat.html"
                                                    class="absolute h-full w-full inset-0"></a>
                                                <div class="">
                                                    <h5 class="text-sm text-gray-800 dark:text-white font-semibold">
                                                        Shakira Sen</h5>
                                                    <span class="text-xs text-gray-500 dark:text-white/70">I would like
                                                        to discuss about that assets...</span>
                                                </div>
                                                <div class="min-w-fit ltr:ml-2 rtl:mr-2 text-end">
                                    ...
                                    <li class="p-0 mb-5 ti-list-group border-0 text-gray-800 dark:text-white w-full">
                                        <div class="flex items-start w-full">
                                            <a href="chat.html" class="ltr:mr-2 rtl:ml-2 avatar rounded-full">
                                                <img src="<?php echo base_url(); ?>dist/assets/img/users/21.jpg"
                                                    alt="img" class="rounded-full">
                                            </a>
                                            <div class="flex justify-between relative w-full">
                                                <a aria-label="anchor" href="chat.html"
                                                ...
                                                <div class="">
                                                    <h5 class="text-sm text-gray-800 dark:text-white font-semibold">
                                                        Sebastian</h5>
                                                    <span class="text-xs text-gray-500 dark:text-white/70">Shall we go
                                                        to the cafe at downtown...</span>
                                                </div>
                                                <div class="min-w-fit ltr:ml-2 rtl:mr-2 text-end">
                                                    <p class="text-xs text-gray-500 dark:text-white/70 mb-1">yesterday
                                                    </p>
                                                    <span
                                                        class="relative inline-flex rounded-full h-5 w-5 bg-primary text-white justify-center items-center">2</span>
                                                </div>
                                    ...
                                    <li class="p-0 mb-5 ti-list-group border-0 text-gray-800 dark:text-white w-full">
                                        <div class="flex items-start w-full">
                                            <a href="chat.html" class="ltr:mr-2 rtl:ml-2 avatar rounded-full">
                                                <img src="<?php echo base_url(); ?>dist/assets/img/users/11.jpg"
                                                    alt="img" class="rounded-full">
                                            </a>
                                            <div class="flex justify-between relative w-full">
                                                <a aria-label="anchor" href="chat.html"
                                                ...
                                                <div class="">
                                                    <h5 class="text-sm text-gray-800 dark:text-white font-semibold">
                                                        Charlie Davieson</h5>
                                                    <span class="text-xs text-gray-500 dark:text-white/70">Lorem ipsum
                                    ...
                                    <li class="p-0 mb-0 ti-list-group border-0 text-gray-800 dark:text-white w-full">
                                        <div class="flex items-start w-full">
                                            <a href="chat.html" class="ltr:mr-2 rtl:ml-2 avatar rounded-full">
                                                <img src="<?php echo base_url(); ?>dist/assets/img/users/3.jpg"
                                                    alt="img" class="rounded-full">
                                            </a>
                                            <div class="flex justify-between relative w-full">
                                                <a aria-label="anchor" href="chat.html"
                                                ...
                                                <div class="">
                                                    <h5 class="text-sm text-gray-800 dark:text-white font-semibold">
                                                        Selena Deoyl</h5>
                                                    <span class="text-xs text-gray-500 dark:text-white/70">Phasellus
                                                        vehicula at enim a pulvinar</span>
                                                </div>
                                                <div class="min-w-fit ltr:ml-2 rtl:mr-2 text-end">
                                                    <p class="text-xs text-gray-500 dark:text-white/70 mb-1">yesterday
                                                    </p>
                                        ...
                                        <a href="javascript:void(0);">
                                            <div class="flex items-center justify-between">
                                                ...
                                                <div class="space-x-2 rtl:rotate-180">
                                                    <i
                                                        class="ri ri-arrow-right-s-line text-gray-500 dark:text-white/70 text-lg"></i>
                                                </div>
                                            </div>
                                        </a>
                                    </li>
                                                ...
                                                <div class="flex items-center space-x-3 rtl:space-x-reverse">
                                                    <div>
                                                        <span
                                                            ...
                                                            <i
                                                                class="ri ri-shopping-basket-line leading-none text-xl"></i>
                                                        </span>
                                                    </div>
                                                    <div class="ltr:ml-3 rtl:mr-3">
                                                        <h3 class="text-sm font-semibold">
                                                ...
                                                <div>
                                                    <a href="javascript:void(0);">
                                                        ...
                                                        <p
                                                            ...
                                                            09:00AM<span
                                                                class="badge bg-success/10 ltr:ml-2 rtl:mr-2">Birthday</span>
                                                        </p>
                                                        <p
                                                            class="mb-1 truncate timeline-widget-content text-sm text-wrap !max-w-[15rem]">
                                                            Amet sed
                            ...
                            <div class="box-body">
                                ...
                                <div class="mb-2">
                                    ...
                                    <input type="text" id="input-label" class="ti-form-input"
                                        placeholder="Account Number" value="2563658568556">
                                </div>
                                <div class="mb-2">
                                    <label for="input-label2" class="ti-form-label">Enter Amount</label>
                                    <input type="number" id="input-label2" class="ti-form-input"
                                        placeholder="Enter Amount" value="2350">
                                </div>
                                <div class="mb-2">
                                    <label for="input-label2" class="ti-form-label">Enter Notes</label>
                                    <textarea class="ti-form-input" rows="1"
                                        placeholder="Add some notes here"></textarea>
                                </div>
                                <div class="flex justify-between">
                                    <a href="javascript:void(0);" class="mb-0 w-full ti-btn ti-btn-primary">Send
                                        Money</a>
                                    ...
                                    <table class="ti-custom-table ti-custom-table-head whitespace-nowrap">
                                        ...
                                        <tbody class="">
                                                    ...
                                                    <div class="flex space-x-3 rtl:space-x-reverse text-start">
                                                        ...
                                                        <div class="block my-auto">
                                                            <p
                                                                ...
                                                                Itumay</p>
                                                            <span
                                                                class="block text-xs text-gray-400 dark:text-white/80 !font-normal my-auto min-w-[180px]">socratesitumay@gmail.com</span>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>#256585</td>
                                            ...
                                            <tr class="">
                                                    ...
                                                    <div class="flex space-x-3 rtl:space-x-reverse text-start">
                                                        ...
                                                        <div class="block my-auto">
                                                            <p
                                                                ...
                                                                Luke Cooper</p>
                                                            <span
                                                                class="block text-xs text-gray-400 dark:text-white/80 !font-normal my-auto min-w-[180px]">LukeCooper@gmail.com</span>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>#256586</td>
                                                ...
                                                <td>Credited</td>
                                                <td><span
                                                        class="truncate whitespace-nowrap inline-block py-1 px-3 rounded-full text-xs font-medium bg-primary/10 text-primary/80">Pending</span>
                                                </td>
                                                <td class="font-medium space-x-2 rtl:space-x-reverse">
                                                    <div class="hs-tooltip ti-main-tooltip">
                                                        <a href="javascript:void(0);"
                                            ...
                                            <tr class="">
                                                ...
                                                <td>
                                                    <div class="flex space-x-3 rtl:space-x-reverse text-start">
                                                        <img class="avatar avatar-sm rounded-sm"
                                                            src="<?php echo base_url(); ?>dist/assets/img/users/14.jpg"
                                                            alt="Image Description">
                                                        <div class="block my-auto">
                                                            <p
                                                                class="block text-sm font-semibold my-auto text-gray-800 dark:text-white">
                                                                Rony Brad</p>
                                                            <span
                                                                class="block text-xs text-gray-400 dark:text-white/80 !font-normal my-auto min-w-[180px]">RonyBrad@gmail.com</span>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>#256587</td>
                                            ...
                                            <tr class="">
                                                ...
                                                <td>Debited</td>
                                                <td><span
                                                        class="truncate whitespace-nowrap inline-block py-1 px-3 rounded-full text-xs font-medium bg-danger/10 text-danger/80">Cancel</span>
                                                </td>
                                                <td class="font-medium space-x-2 rtl:space-x-reverse">
                                                    <div class="hs-tooltip ti-main-tooltip">
                                                        <a href="javascript:void(0);"
                                                    ...
                                                    <div class="flex space-x-3 rtl:space-x-reverse text-start">
                                                        ...
                                                        <div class="block my-auto">
                                                            <p
                                                                ...
                                                                Cooper Hard</p>
                                                            <span
                                                                class="block text-xs text-gray-400 dark:text-white/80 !font-normal my-auto min-w-[180px]">CooperHard@gmail.com</span>
                                                        </div>
                                                    </div>
                                                </td>
                                                <td>#256589</td>
