            ...
            <div class="Properties_section_2">
               <div class="row">
                  <div class="col-lg-4 col-md-6col-lg-4 col-md-6">
                     <div class="blog_img"><img src="<?php echo base_url(); ?>assets/images/img-4.png"></div>
                     <div class="image_box">
                        <div class="left_box">
                  ...
                  <div class="col-lg-4 col-md-6">
                     <div class="blog_img"><img src="<?php echo base_url(); ?>assets/images/img-5.png"></div>
                     <div class="image_box">
                        <div class="left_box">
                           <h1 class="road_text">2186 Lohariya Road</h1>
                           <div class="area_main">
                  ...
                  <div class="col-lg-4 col-md-6">
                     <div class="blog_img"><img src="<?php echo base_url(); ?>assets/images/img-6.png"></div>
                     <div class="image_box">
                        <div class="left_box">
                           <h1 class="road_text">2186 Lohariya Road</h1>
                           <div class="area_main">
                  ...
                  <div class="col-lg-4 col-md-6">
                     <div class="blog_img"><img src="<?php echo base_url(); ?>assets/images/img-7.png"></div>
                     <div class="image_box">
                        <div class="left_box">
                           <h1 class="road_text">2186 Lohariya Road</h1>
                           <div class="area_main">
                  ...
                  <div class="col-lg-4 col-md-6">
                     <div class="blog_img"><img src="<?php echo base_url(); ?>assets/images/img-8.png"></div>
                     <div class="image_box">
                        <div class="left_box">
                           <h1 class="road_text">2186 Lohariya Road</h1>
                           <div class="area_main">
                  ...
                  <div class="col-lg-4 col-md-6">
                     <div class="blog_img"><img src="<?php echo base_url(); ?>assets/images/img-9.png"></div>
                     <div class="image_box">
                        <div class="left_box">
                           <h1 class="road_text">2186 Lohariya Road</h1>
                           <div class="area_main">
         ...
         <div class="blog_section_2">
            <div class="container-fluid">
                <div class="row">
                  ...
                  <div class="col-md-6">
                     <div class="blog_img"><img src="<?php echo base_url(); ?>assets/images/blog-img.png"></div>
                  </div>
               </div>
            </div>
         </div>
                              ...
                              <div class="box_main">
                                 <div class="customer_main">
                                    <div class="customer_left">
                                       <div class="customer_img"><img src="<?php echo base_url(); ?>assets/images/customer-img.png"></div>
                                    </div>
                                    <div class="customer_right">
                                       <h3 class="customer_name">DenoMark <span class="quick_icon"><img src="<?php echo base_url(); ?>assets/images/quick-icon.png"></span></h3>
                     ...
                     <div class="mail_section map_form_container">
                        ...
                        <div class="map_main map_container">
                           <div class="map-responsive">
                              <iframe src="<?php echo base_url(); ?>assets/https://www.google.com/maps/embed/v1/place?key=AIzaSyA0s1a7phLN0iaD6-UE7m4qP-z21pH0eSc&amp;q=Eiffel+Tower+Paris+France" width="600" height="368" frameborder="0" style="border:0; width: 100%;" allowfullscreen=""></iframe>
                               <div class="btn_main">
